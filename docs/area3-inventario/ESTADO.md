...
- Módulo construido en `src/modules/area3-inventario/` con servicios en `src/services/area3/`: catálogo con alta y edición, entrada simple, kardex con filtro de fechas, conciliación y reportes de discrepancias y rotación. Consultas verificadas con sesión real. Falta la prueba en navegador para cerrar los issues.
